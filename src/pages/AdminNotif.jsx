...
const generateMockNotifications = () => {
  ...
  return [
    { id: '1', type: 'success', message: 'Admin: New user registered successfully!', read: false, createdAt: now.toISOString() },
    { id: '2', type: 'warning', message: 'Admin: System update scheduled for tomorrow.', read: false, createdAt: tenMinutesAgo },
    { id: '3', type: 'error', message: 'Admin: Database connection failed. Investigate immediately!', read: false, createdAt: oneHourAgo },
    { id: '4', type: 'info', message: 'Admin: Welcome, Admin User!', read: true, createdAt: oneDayAgo },
    { id: '5', type: 'success', message: 'Admin: Report generated successfully.', read: true, createdAt: twoDaysAgo },
    { id: '6', type: 'warning', message: 'Admin: High CPU usage detected on server.', read: true, createdAt: twoDaysAgo },
  ];
};
...
const AdminNotificationsPage = () => { // Renamed from NotificationsPage
  ...
  // The following theme-related helper functions might be redundant if already handled by CSS classes.
  // Keeping them for now as they were in the original code, but consider if they're truly needed.
...
const AdminNotif = () => { // Renamed from Notifications
  return (
    <div className="Notifpage">
      <Sidebar />
      <div className="Notifpage-content">
        <AdminNotificationsPage /> {/* Using the renamed component */}
      </div>
    </div>
  );
};

export default AdminNotif; // Exporting the new component name